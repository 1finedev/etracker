...
export function useMakeRequest() {
    ...
    const axiosRequest = (method, endpoint, values = {}, headers = {}) => {
        ...
        let response = axios({
            ...
            .catch(function (err) {
                ...
                return { message: err.response.data.message, error: err.response.status };
            })
    ...
    const postRequest = (endpoint, values = {}, headers = {}) => {
        ...
        let response = axios
            .post(`${PROXY}${endpoint}`, { ...values }, { headers: { ...headers, ...config } })
            .then(function (res) {
                dispatch({ type: ACTIONS.GET_RESPONSE })
                return { response: res.data, status: res.status };
            })
            .catch(function (err) {
                console.log(err);
                dispatch({ type: ACTIONS.ERROR, payload: { error: err } })
                return { response: err.response.data.message, status: err.response.status };
            })
    ...
    const patchRequest = (endpoint, id = '', values = {}, headers = {}) => {
        ...
        let response = axios
            .patch(`${PROXY}${endpoint}/${id}`, { ...values }, { headers: { ...headers, ...config } })
            .then(function (res) {
                dispatch({ type: ACTIONS.GET_RESPONSE })
                return { response: res.data, status: res.status };
            })
    ...
    const deleteRequest = (endpoint, id = '', values = {}, headers = {}) => {
        ...
        let response = axios
            .delete(`${PROXY}${endpoint}/${id}`, { ...values }, { headers: { ...headers, ...config } })
            .then(function (res) {
                dispatch({ type: ACTIONS.GET_RESPONSE })
                return { response: res.data, status: res.status };
            })
    ...
    return { axiosRequest, postRequest, getRequest, deleteRequest, patchRequest, ...state };
}